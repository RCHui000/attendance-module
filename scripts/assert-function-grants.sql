...
--   authenticated EXECUTE grants: 16
...
BEGIN
  ...
  IF v_summary.public_schema_functions <> 44 THEN
    RAISE EXCEPTION 'Expected 44 public schema functions, got %', v_summary.public_schema_functions;
  END IF;
  ...
  IF v_summary.authenticated_execute <> 16 THEN
    RAISE EXCEPTION 'Expected 16 authenticated EXECUTE grants, got %', v_summary.authenticated_execute;
  END IF;
