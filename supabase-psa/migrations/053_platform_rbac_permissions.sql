...
CREATE POLICY "Admin write permission roles" ON public.permission_roles
...
CREATE POLICY "Admin write permission resources" ON public.permission_resources
  FOR ALL USING (public.current_user_has_role('admin'))
  WITH CHECK (public.current_user_has_role('admin'));
...
CREATE POLICY "Admin write role permissions" ON public.role_permissions
  FOR ALL USING (public.current_user_has_role('admin'))
  WITH CHECK (public.current_user_has_role('admin'));
